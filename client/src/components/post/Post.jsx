        ...
        <div className="wrapper">
            ...
            <div className="privacy">
              {privacy ? (
                <>
                  ...
                  <span onClick={() => setPrivacy((prev) => !prev)}>
                    Private
                  </span>
                </>
              ) : (
          ...
          <div className="bottom">
            ...
            <div className="content">
              ...
              <button type="submit" className={`post ${active}`}>
                Express
              </button>
            </div>
          </div>
        ...
        return (
          <div className="wrapper" key={post.id}>
            <div className="input-box">
              ...
              <button onClick={(e) => onDeletePost(post.id)} className="delete">
                Delete
              </button>
            </div>
          </div>
